...
#st.set_page_config(page_title="Chat with your files", layout="centered")
model_choice = {
   # "id1": "Gemini-2.5",
    "id2": "Gemini-2.0",
    "id3": "Gemini-1.5",
...
def main():
    ...
    with st.sidebar:
        st.title("Menu:")
        #st.sidebar.selectbox("Choose Model:", list(model_choice.items()), 0 , format_func=lambda o: o[1])
        #model_list = st.sidebar.selectbox("Choose Model:", list(model_choice.items()), 0 , format_func=lambda o: o[1])
